    ...
    extension Event.Actor {
        ...
        public func deregister(_ descriptorID: Event.ID) {
            ...
            do throws(Kernel.Event.Driver.Error) {
                ...
                // Best-effort: the registration table entry is already gone
                // above, so a driver-level deregister failure here is not
                // observable to callers and there is nothing further to undo.
            }
        }
    }
